...
#include "Hydra/AttrList.hpp"
/*#include "Hydra/ChannelDestinatopnchannel_destination.hpp"
#include "core/channel/channel_source.hpp"*/

namespace arangodb {
namespace hydra {

// Common superclass for ObjList, mostly for keeping pointer references
...
public:
  ...
  inline bool isSorted() const { return _sorted; }
